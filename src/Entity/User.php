...
class User implements UserInterface
{
     ...
     * @Assert\Url(message="vous devez renseignez un url valide")
     */
    private $picture;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=10, minMessage="Votre introduction doit contenir minumum 10 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=50, minMessage="Votre description doit contenir au minumum 50 caractères")
     */
    private $description;
